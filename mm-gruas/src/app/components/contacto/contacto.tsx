        ...
        <div className="text-black space-y-4 md:text-left text-center">
          ...
          <div className="space-y-3">
            <ul className="list-none p-0 space-y-2">
              <li>
                <h4 className="text-lg mb-1 flex items-center gap-x-1 space-y-2"><MapPin className="inline" size={18}/>Ubicación</h4>
                <Link
                  href="https://www.google.com/maps?q=-36.011277, -59.111919"
                  target="_blank"
                  className="text-gray-500 py-1 font-medium hover:text-gray-700 mb-2"
                >
                  Moreno esq. R. Vera, Las Flores, Pcia. de Buenos Aires
                </Link>

                <h4 className="text-lg mb-1 flex items-center gap-x-1"><Clock className="inline" size={18}/>Horario de atención (en la sede)</h4>
                <p className="text-gray-700 py-1">9:00 a 17:00hs</p>
              </li>

              <li>
                <div>
                  <h4 className="text-lg mb-1 flex items-center mt-3 gap-x-1"><Phone className="inline" size={18}/>Teléfono</h4>
                  <Link
                    href="tel:+5492244462235"
                    className="text-gray-700 py-1 font-medium hover:text-gray-700"
                  >
                    +54 9 2244 46-2235
                  </Link>
                </div>
